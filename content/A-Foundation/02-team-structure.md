...
All Operations Managers report up through the following chain:

**OM-L1/L2 → Senior OM-L1/L2/L3 → Hrishikesh (Founder)**
...
### 3.1 OM-L1 (Operations Manager — Level 1)

**Core focus:** Execute daily operational tasks with process diligence

**Must do:**

- Read and understand the talent persona for each role
- Follow the outreach process diligently — priority order in views, calling candidates multiple times, rejecting unresponsive candidates
- Capture and document all inputs correctly — resume updated with enough details, all custom question inputs filled, all custom column inputs filled, interview dates and times filled
- Follow the process of following up with candidates prior to interviews — morning call and 15 minutes before interview
- Maintain all internal view columns accurately
...
### 3.2 OM-L2 (Operations Manager — Level 2)
...
- Nuanced reviews with almost zero investigative work — reviews should not require follow-up questions
- Set the benchmark for the team in terms of following processes
- Handle entire roles independently including end-to-end candidate management
- Begin client interaction — collect feedback, present to Senior OM
- Take automation ownership — understand and manage product automations
- Build a revenue mindset — understand the commercial impact of your work
...
**Account Setup** ("Launch the customer"): Structured onboarding of a new client into Flexiple's delivery system. Includes aligning on hiring process, finalizing talent persona, establishing collaboration norms, and setting up the interview pipeline. *Owner: Senior OM (with Hrishikesh oversight)*

**Role Setup** ("Spin up a new JD inside an existing account"): Onboarding of a new hiring role within an existing client account. Mirrors account setup but benefits from existing context and prior learnings. *Owner: Senior OM*

**Day-to-Day Operations**: Continuous execution of hiring tasks post-setup — sourcing, recommendation sharing, interview coordination, follow-ups, escalation handling, and tracking. *Owner: Senior OM (assisted by L1/L2 OMs)*
...
> [!note] See Also
> - [[11-l1-playbook|L1 Playbook]] — What's expected at L1
> - [[12-l2-playbook|L2 Playbook]] — What's expected at L2
> - [[13-senior-om-playbook|Senior OM Playbook]] — Pod leadership guide
