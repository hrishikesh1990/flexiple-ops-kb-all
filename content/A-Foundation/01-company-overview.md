...
- **Talent Persona** — Detailed profile of what the client is looking for
- **Custom Questions** — Specific questions to qualify candidates for each role
- **Views** — Organized lists of candidates with auto-scoring and prioritization
- **Tagging** — Identify talent quality and outreach stage
- **Candidate Details** — Basic recruiter checks, resume, and company details
...
For detailed product training, see: [[18-product-tools-guide|Product & Tools Guide]]
...
- **L1 OMs** drive the top of the funnel — sourcing candidates, sending recommendations, scheduling interviews
- **L2 OMs** improve conversion quality — better client interaction, independent execution, fewer dropped candidates
- **Senior OMs** own revenue delivery — managing the full pipeline, team output, client relationships, role setup, and account setup
- **Hrishikesh (Founder)** provides strategic oversight — performance reviews, target setting, and new account activation support
